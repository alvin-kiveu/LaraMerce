        ...
        <div class="card-body">
            <div class="table-responsive">
                ...
                <p class="content-group">
                    <button type="button" class="btn btn-secondary" onclick="window.location.href='/laradmin/install'">Back</button>
                    @if (
                        $php['supported'] &&
                        $pdoInstalled &&
                        $pdoMysqlInstalled &&
                        ...
                        <button type="button" class="btn btn-primary" onclick="window.location.href='/laradmin/install/environmentsetup'">Next Step</button>
                    @else
